...
export interface SkyProps extends ElementProps<typeof Mesh, Mesh & Required<AtmosphereMaterialProps> & {
    sun: boolean;
    moon: boolean;
...
export declare const Sky: import('react').ForwardRefExoticComponent<Omit<SkyProps, "ref"> & import('react').RefAttributes<SkyImpl>>;
